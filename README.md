...
This project represents my first complete attempt at building an ecommerce-style application end to end.
...
- A learning-focused ecommerce build
- An exploration of API integration and real product data
- A demonstration of frontend fundamentals:
  - Routing
  - Component reuse
  - Data-driven UI
